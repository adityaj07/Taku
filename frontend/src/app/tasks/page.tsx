          ...
          >
            ...
            <motion.div variants={cardVariants} className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button className="font-dosis bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600">
            ...
            <motion.div variants={cardVariants}>
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="text-center">
                  <ListChecks className="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
                  ...
                  <p className="font-dosis text-gray-600 dark:text-gray-400">
                    Kanban board, task creation, drag & drop, and time tracking coming soon...
                  </p>
                </div>
              </div>
            </motion.div>
